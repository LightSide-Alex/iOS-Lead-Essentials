...
//  EssentialApp
//
//  Created by Oleksandr Balan on 2022-04-21.
//
...
class DebuggingSceneDelegate: SceneDelegate {
    ...
    override func makeRemoteClient() -> HTTPClient {
        if let connectivity = UserDefaults.standard.string(forKey: "connectivity")
            .flatMap ({ DebuggingHTTPClient.ConnectivityType(rawValue: $0) }) {
...
private class DebuggingHTTPClient: HTTPClient {
    ...
    private let connectivity: ConnectivityType
    
    init(connectivity: ConnectivityType) {
